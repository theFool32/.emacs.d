...
(when (display-graphic-p)
  ...
  (max/set-font "CaskaydiaCove Nerd Font" "Sarasa Mono SC" 15 1.2)
  )
...
(use-package org
  ...
  (setq org-tag-alist '(("academic" . ?a) ("personal" . ?p) ("emacs" . ?e) ("work" . ?w) ("company" . ?c) ("habit" . ?h) ("ACT_MONTH" . ?m) ("ACT_WEEK" . ?W)))
